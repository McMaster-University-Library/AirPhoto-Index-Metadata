...
inDir='H:\Digitization_Projects\Air_Photos\AirPhotos_1954-1955_OntarioS'
#This command is for running the script on multiple subdirectories: input('Insert the directory path  of where the tifs are stored within single quotations (ex: \'C:/Digitization_Projects/AirPhotos\'). Copy it here and press enter: ')#modify this string to the location where the folders containing the airphotos is
